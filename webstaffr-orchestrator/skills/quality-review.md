...
name: quality-review
version: 1.0.0
description: Review a Hermes subagent's completed work before treating it as done, committing, or updating TASKS.md/CLAUDE.md. Use after every subagent-dispatch completes, whether from one subagent or several run in parallel.
...
- **Not approved:** send it back to a fresh Hermes dispatch with the specific gap, not a vague "try again."
